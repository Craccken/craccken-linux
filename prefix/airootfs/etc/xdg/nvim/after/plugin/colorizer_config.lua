...
require("colorizer").setup({ -- Attach to certain filetypes.
    ...
    RGB = true;             -- #RGB hex codes, ex: #321, #123, #439
    names = true;           -- "Name" codes, ex: Blue, Red, Green, White, Black
    RRGGBB = true;          -- #RRGGBB hex codes, ex: #af0000, #00aff0, #011025
    RRGGBBAA = true;        -- #RRGGBBAA hex codes, ex: #aff00095
