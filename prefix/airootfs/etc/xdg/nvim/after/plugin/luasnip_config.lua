...
require("luasnip").config.setup({ -- Call setup function
    ...
    enable_autosnippets = false,    -- Autosnippets are disabled by default to minimize performance penalty if unused. Set to true to enable.
    -- update_events = "InsertLeave",  -- Choose which events trigger an update of the active nodes' dependents. Default is just 'InsertLeave', 'TextChanged,TextChangedI' would update on every change.
